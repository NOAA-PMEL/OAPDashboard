 ...
 *
 */
public class Baggy implements ArchiveBundler {

    private static Logger logger = LogManager.getLogger(Baggy.class);
    ...
    public static File Bag(SubmissionRecord submitRecord, String datasetId, 
        ...
        Path staged = null;
        try {
            bagger = new Baggy(submitRecord, datasetId, submitProperties, false, store);
     ...
     * 
     */
    public Baggy(SubmissionRecord submitRecord, String datasetId, DashboardConfigStore store) {
        this(submitRecord, datasetId, null, false, store);
    }
    
    public Baggy(SubmissionRecord submitRecord, String datasetId, 
