...
public class TrajectoryDatasetChecker extends BaseDatasetChecker implements DatasetChecker {
	 ...
	 */
	public TrajectoryDatasetChecker(KnownDataTypes userDataTypes, 
...
//	      }
	...
	public static void main(String[] args) {
        try {
            ...
            DatasetChecker dc = cfg.getDashboardDatasetChecker(FeatureType.TRAJECTORY);
            StdUserDataArray std = dc.standardizeDataset(dataset);
