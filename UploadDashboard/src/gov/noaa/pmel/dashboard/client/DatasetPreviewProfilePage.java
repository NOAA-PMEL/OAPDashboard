 ...
 * @author Karl Smith
 */
public class DatasetPreviewProfilePage extends CompositeWithUsername {
	...
	interface DatasetPreviewPageUiBinder extends UiBinder<Widget, DatasetPreviewProfilePage> {
	}
...
//	@UiField ResizeLayoutPanel resizePanel;
	...
	private static DatasetPreviewProfilePage singleton;

	public DatasetPreviewProfilePage() {
	...
	static void showPage(DashboardDatasetList cruiseList) {
		if ( singleton == null )
			singleton = new DatasetPreviewProfilePage();
